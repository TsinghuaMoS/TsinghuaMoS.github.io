---
title: "博士后、全职科研助理、科研实习生与访问学生招聘 — 清华大学交通科学实验室"
layout: textlay
excerpt: "清华大学交通科学实验室招聘博士后、全职科研助理、科研实习生与访问学生。"
sitemap: true
lang: zh
hreflang: true
alt_en: "/en/admission/"
...
- **交通系统韧性与运营优化**：交通系统扰动管理、资源配置、路径推荐、鲁棒优化与智能调度。
- **AI for Transportation**：强化学习、时序预测大模型、交通管理 Agent，以及人工智能在公共交通、共享出行和供应链物流中的应用。
- **出行行为与需求建模**：计量经济学、离散选择模型、现代机器学习与优化理论驱动的行为和需求分析。
- **可持续城市系统**：通勤碳排放、公共健康、住房流动性及城市信息物理社会系统韧性。
...
<img class="advisor-photo" src="{{ site.url }}{{ site.baseurl }}/images/teampic/optimized/baichuan_mo.webp" alt="莫佰川" width="384" height="384" decoding="async">
...
完整履历请见 [个人主页]({{ site.url }}{{ site.baseurl }}/team/baichuan_mo/)。
...
请将以下材料发送至 [bmo[at]tsinghua.edu.cn](mailto:bmo@tsinghua.edu.cn)：
