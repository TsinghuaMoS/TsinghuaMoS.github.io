...
<img class="advisor-photo" src="{{ site.url }}{{ site.baseurl }}/images/teampic/optimized/baichuan_mo.webp" alt="Baichuan Mo" width="384" height="384" decoding="async">
...
See his full [faculty profile]({{ site.url }}{{ site.baseurl }}/en/team/baichuan_mo.html).
...
Please email the following materials to [bmo[at]tsinghua.edu.cn](mailto:bmo@tsinghua.edu.cn):
